#ifndef HALIDE__bin___host___threednr_h
#define HALIDE__bin___host___threednr_h
#include <stdint.h>
...
int threednr(struct halide_buffer_t *_input_0_buffer, struct halide_buffer_t *_input_1_buffer, struct halide_buffer_t *_input_2_buffer, struct halide_buffer_t *_input_3_buffer, struct halide_buffer_t *_input_4_buffer, struct halide_buffer_t *_input_5_buffer, struct halide_buffer_t *_input_6_buffer, struct halide_buffer_t *_input_7_buffer, int32_t _number_of_input, int32_t _width, int32_t _height, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int threednr_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *threednr_metadata();
